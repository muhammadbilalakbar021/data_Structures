...
public class test_class
{
    public static void main(String[] args) throws IOException
    {
        ...
        File coorect_File = new File("E:\\intellij_Idea\\data_Structures\\src\\trie_Work/corect_dic.txt");
        ...
        BufferedReader coorect_File_Reader = new BufferedReader(new InputStreamReader(new FileInputStream(incorrect_File)));
...
//                System.out.println(word[i]);
            ...
            incorrect_Line=incorrect_File_Reader.readLine();
            corr_Line=coorect_File_Reader.readLine();
        }

        object.search("jogging");
    }
}
